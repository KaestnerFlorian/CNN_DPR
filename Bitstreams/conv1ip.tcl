...
CONFIG.NUM_PORTS {6} \
  ...
  connect_bd_net -net proc_sys_reset_142M_interconnect_aresetn [get_bd_pins interconnect_aresetn] [get_bd_pins proc_sys_reset_142M/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_142M_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins proc_sys_reset_142M/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins FCLK_CLK0] [get_bd_pins proc_sys_reset_100M/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins FCLK_CLK1] [get_bd_pins proc_sys_reset_142M/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins FCLK_CLK2] [get_bd_pins proc_sys_reset_200M/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK2]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins FCLK_RESET0_N] [get_bd_pins proc_sys_reset_100M/ext_reset_in] [get_bd_pins proc_sys_reset_142M/ext_reset_in] [get_bd_pins proc_sys_reset_166M/ext_reset_in] [get_bd_pins proc_sys_reset_200M/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins interconnect_aresetn1] [get_bd_pins proc_sys_reset_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins peripheral_aresetn1] [get_bd_pins proc_sys_reset_100M/peripheral_aresetn]
...
CONFIG.NUM_MI {3} \
  ...
  # Create instance: convHW_depth_0, and set properties
  set convHW_depth_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:convHW_depth:1.0 convHW_depth_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins convHW_depth_0/input_V]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M01_AXI [get_bd_intf_pins axi_interconnect_1/M01_AXI] [get_bd_intf_pins convHW_depth_0/s_axi_AXILiteS]
  ...
  connect_bd_intf_net -intf_net convHW_depth_0_m_axi_WeightsIn [get_bd_intf_pins axi_interconnect_0/S02_AXI] [get_bd_intf_pins convHW_depth_0/m_axi_WeightsIn]
  connect_bd_intf_net -intf_net convHW_depth_0_outputStream_V [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins convHW_depth_0/outputStream_V]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_1/ARESETN]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins convHW_depth_0/ap_rst_n]
  connect_bd_net -net axi_resetn_1 [get_bd_pins axi_resetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/M02_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN]
  connect_bd_net -net s_axi_lite_aclk_1 [get_bd_pins s_axi_lite_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins convHW_depth_0/ap_clk]
...
CONFIG.C_HAS_ASYNC_CLK {1} \
  ...
  connect_bd_net -net proc_sys_reset_142M_peripheral_aresetn [get_bd_pins M00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins m_axi_s2mm_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins v_vid_in_axi4s_0/aclk]
...
CONFIG.NUM_MI {7} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S00_AXI_2 [get_bd_intf_pins proc/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M06_AXI]
  ...
  connect_bd_intf_net -intf_net S_AXI_ACP_1 [get_bd_intf_pins proc/M00_AXI] [get_bd_intf_pins ps/S_AXI_HP1]
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_M00_AXI [get_bd_intf_pins hdmi/M00_AXI] [get_bd_intf_pins ps/S_AXI_HP0]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_IIC_0 [get_bd_intf_ports hdmi_out_ddc] [get_bd_intf_pins ps/IIC_0]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0_axi_periph/S00_AXI] [get_bd_intf_pins ps/M_AXI_GP0]
  ...
  connect_bd_net -net hdmi_ip2intc_irpt [get_bd_pins hdmi/ip2intc_irpt] [get_bd_pins ps/In5]
  connect_bd_net -net hdmi_ip2intc_irpt1 [get_bd_pins hdmi/ip2intc_irpt1] [get_bd_pins ps/In4]
  connect_bd_net -net hdmi_irq [get_bd_pins hdmi/irq] [get_bd_pins ps/In3]
  connect_bd_net -net hdmi_irq1 [get_bd_pins hdmi/irq1] [get_bd_pins ps/In2]
  connect_bd_net -net hdmi_mm2s_introut [get_bd_pins hdmi/mm2s_introut] [get_bd_pins ps/In1]
  connect_bd_net -net hdmi_out_hpd_video_gpio_io_o [get_bd_ports hdmi_out_hpd] [get_bd_pins hdmi/gpio_io_o]
  connect_bd_net -net hdmi_s2mm_introut [get_bd_pins hdmi/s2mm_introut] [get_bd_pins ps/In0]
  connect_bd_net -net proc_sys_reset_142M_interconnect_aresetn [get_bd_pins hdmi/ARESETN] [get_bd_pins ps/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_142M_peripheral_aresetn [get_bd_pins hdmi/M00_ARESETN] [get_bd_pins ps/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins hdmi/REF_CLK_I] [get_bd_pins proc/s_axi_lite_aclk] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/M05_ACLK] [get_bd_pins processing_system7_0_axi_periph/M06_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins ps/FCLK_CLK0]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins hdmi/m_axi_s2mm_aclk] [get_bd_pins ps/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins hdmi/RefClk] [get_bd_pins ps/FCLK_CLK2]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins hdmi/ext_reset_in] [get_bd_pins ps/FCLK_RESET0_N]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins proc/ARESETN] [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins ps/interconnect_aresetn1]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins hdmi/s00_axi_aresetn] [get_bd_pins proc/axi_resetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M05_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M06_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins ps/peripheral_aresetn1]

  # Create address segments
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces hdmi/axi_vdma_0/Data_MM2S] [get_bd_addr_segs ps/processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces hdmi/axi_vdma_0/Data_S2MM] [get_bd_addr_segs ps/processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces proc/axi_dma_0/Data_MM2S] [get_bd_addr_segs ps/processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_0_HP1_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces proc/axi_dma_0/Data_S2MM] [get_bd_addr_segs ps/processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_0_HP1_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces proc/convHW_depth_0/Data_m_axi_WeightsIn] [get_bd_addr_segs ps/processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_0_HP1_DDR_LOWOCM
  create_bd_addr_seg -range 0x00010000 -offset 0x40400000 [get_bd_addr_spaces ps/processing_system7_0/Data] [get_bd_addr_segs proc/axi_dma_0/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces ps/processing_system7_0/Data] [get_bd_addr_segs hdmi/axi_dynclk_0/s00_axi/reg0] SEG_axi_dynclk_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x41220000 [get_bd_addr_spaces ps/processing_system7_0/Data] [get_bd_addr_segs proc/axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces ps/processing_system7_0/Data] [get_bd_addr_segs hdmi/axi_gpio_video/S_AXI/Reg] SEG_axi_gpio_video_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43000000 [get_bd_addr_spaces ps/processing_system7_0/Data] [get_bd_addr_segs hdmi/axi_vdma_0/S_AXI_LITE/Reg] SEG_axi_vdma_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces ps/processing_system7_0/Data] [get_bd_addr_segs proc/convHW_depth_0/s_axi_AXILiteS/Reg] SEG_convHW_depth_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces ps/processing_system7_0/Data] [get_bd_addr_segs hdmi/hdmi_out_hpd_video/S_AXI/Reg] SEG_hdmi_out_hpd_video_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces ps/processing_system7_0/Data] [get_bd_addr_segs hdmi/v_tc_0/ctrl/Reg] SEG_v_tc_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces ps/processing_system7_0/Data] [get_bd_addr_segs hdmi/v_tc_1/ctrl/Reg] SEG_v_tc_1_Reg
