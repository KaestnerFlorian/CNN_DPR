...
CONFIG.NUM_MI {3} \
  ...
  # Create instance: convHW_0, and set properties
  set convHW_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:convHW:1.0 convHW_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins convHW_0/input_V]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M01_AXI [get_bd_intf_pins axi_interconnect_1/M01_AXI] [get_bd_intf_pins convHW_0/s_axi_AXILiteS]
  connect_bd_intf_net -intf_net convHW_0_m_axi_WeightsIn [get_bd_intf_pins axi_interconnect_0/S02_AXI] [get_bd_intf_pins convHW_0/m_axi_WeightsIn]
  connect_bd_intf_net -intf_net convHW_0_outputStream_V [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins convHW_0/outputStream_V]
  ...
  connect_bd_net -net axi_resetn_1 [get_bd_pins axi_resetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_0/S02_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/M02_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins convHW_0/ap_rst_n]
  connect_bd_net -net s_axi_lite_aclk_1 [get_bd_pins s_axi_lite_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins convHW_0/ap_clk]
...
CONFIG.NUM_MI {7} \
  ...
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces proc/convHW_0/Data_m_axi_WeightsIn] [get_bd_addr_segs ps/processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_0_HP1_DDR_LOWOCM
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces ps/processing_system7_0/Data] [get_bd_addr_segs proc/convHW_0/s_axi_AXILiteS/Reg] SEG_convHW_0_Reg
